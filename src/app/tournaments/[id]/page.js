      ...
      >
        ...
        >
          {[
            ...
            { id: 'standings', label: 'Klasemen', icon: Trophy, show: Array.isArray(standings) ? standings.length > 0 : (standings?.standings?.length > 0 || standings?.groups?.length > 0 || standings?.phases?.length > 0) },
