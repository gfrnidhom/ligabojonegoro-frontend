      ...
      >
        {activeTab === 'matches' && (
          ...
          <div className="animate-fade-in" style={{ padding: '0 4px', display: 'flex', flexDirection: 'column', gap: 24 }}>
            ...
            <div style={{ background: 'var(--bg-subtle)', borderRadius: 24, border: '1px solid var(--border)', overflow: 'hidden', position: 'relative' }}>
              <div style={{ position: 'absolute', top: -50, right: -50, width: 150, height: 150, background: '#10b981', filter: 'blur(80px)', opacity: 0.1 }} />
...
function StandingsTable({ rows = [], match, sport }) {
  ...
  const resultColor = (r) => r === 'W' ? '#22c55e' : r === 'L' ? '#ef4444' : 'var(--text-secondary)';
  ...
  return (
    <div style={{
      background: 'var(--bg-subtle)', borderRadius: 16,
      border: '1px solid var(--border-light)', overflowX: 'auto',
    }} className="hide-scrollbar">
      {/* Header */}
      <div style={{
                ...
                style={{
                  ...
                  background: isHome
                    ...
                    : isAway
                      ...
                      : 'transparent',
                  borderBottom: i === rows.length - 1 ? 'none' : '1px solid var(--bg-subtle)',
                ...
                <div style={{ width: 44, display: 'flex', alignItems: 'center', gap: 6, flexShrink: 0 }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: 12 }}>
                    {r.movement > 0 ? (
                      ...
                      <div style={{ width: 4, height: 1, background: 'var(--text-muted)', borderRadius: 2 }} />
                    )}
                  </div>
                </div>
    ...
    return (
      <div style={{ padding: '14px 0', borderBottom: '1px solid var(--border-light)' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
          <Badge value={h} color={hWin ? '#f59e0b' : 'var(--text-muted)'} />
          <span style={{ fontSize: 12, fontWeight: 600, color: 'var(--text-primary)', textAlign: 'center' }}>{label}</span>
          <Badge value={a} color={aWin ? '#eab308' : 'var(--text-muted)'} />
        </div>
        <div style={{ display: 'flex', height: 5, borderRadius: 3, background: 'var(--border)', gap: 3, margin: '0 4px' }}>
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
      ...
      <div style={{ textAlign: 'center' }}>
        <div style={{ fontSize: 11, fontWeight: 700, color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 10 }}>Penguasaan Bola</div>
        <div style={{ display: 'flex', alignItems: 'center', borderRadius: 8, overflow: 'hidden', height: 28, background: 'var(--border-light)' }}>
          ...
          <div style={{ flex: possHome, background: '#f59e0b', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'flex-end', paddingRight: 8, transition: 'flex 1s ease' }}>
            <span style={{ fontSize: 12, fontWeight: 800, color: 'var(--text-primary)' }}>{possHome}%</span>
          </div>
