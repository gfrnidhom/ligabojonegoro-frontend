...
export default function NewsDetailPage({ params }) {
  ...
  if (!news) {
    return (
      <div style={{ maxWidth: 800, margin: '80px auto', textAlign: 'center', padding: '0 16px' }}>
        <h2 style={{ fontSize: 24, fontWeight: 700, color: '#f1f5f9', marginBottom: 12 }}>Berita Tidak Ditemukan</h2>
        <p style={{ color: '#94a3b8', marginBottom: 24 }}>Berita yang Anda cari mungkin telah dihapus atau URL tidak valid.</p>
  ...
  return (
    <article className="animate-fade-in" style={{ maxWidth: 800, margin: '0 auto', padding: '24px 16px 80px' }}>
      ...
      <div style={{ 
        ...
        marginBottom: 40, background: '#0f172a', border: '1px solid rgba(255,255,255,0.05)'
      }}>
        <img 
          src={coverImage} 
          alt={news.title} 
      ...
      <style dangerouslySetInnerHTML={{__html: `
        ...
        .prose h2 { color: #f8fafc; font-weight: 700; margin-top: 2em; margin-bottom: 0.8em; font-size: 1.5em; }
        .prose h3 { color: #f1f5f9; font-weight: 600; margin-top: 1.5em; margin-bottom: 0.6em; font-size: 1.25em; }
        .prose a { color: #3b82f6; text-decoration: none; }
        .prose a:hover { text-decoration: underline; }
        .prose ul, .prose ol { padding-left: 1.5em; margin-bottom: 1.5em; }
        .prose li { margin-bottom: 0.5em; }
        .prose blockquote { border-left: 4px solid #3b82f6; padding-left: 1em; color: #94a3b8; font-style: italic; }
        .prose img { border-radius: 12px; margin: 2em 0; max-width: 100%; height: auto; }
      `}} />
